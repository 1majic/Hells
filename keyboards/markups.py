...
def subscribe_keyboard():
    ...
    markup.row(
        InlineKeyboardButton(text="Подписаться на канал", url="https://t.me/+xQNLjsq8izxjMjE6")
    ).row(
...
def get_money_keyboard():
    ...
    # btn_398 = InlineKeyboardButton(text="398₽", callback_data="398")
    # btn_498 = InlineKeyboardButton(text="498₽", callback_data="498")
    # btn_2000 = InlineKeyboardButton(text="2000₽", callback_data="2000")

    markup.row(btn_200).row(btn_250)
